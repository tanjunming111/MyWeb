...
var defaultDiaryData = [
    ...
    },
    {
        date: "2026-07-07",
        paragraphs: [
            "添加了更新日志页面。因为新搞一个 JS 关联文件很麻烦，有延迟，而且日志就一个内容，所以我直接在源代码里面编辑就行了。",
            "增加了首页背景图，是从洛谷上我的主页里摘的。其他页的背景图加上去效果一般，和下面简约的风格不搭配，还是不加了。",
            "增加了上一篇和下一篇的快捷链接。",
            "感觉现在用 Tokens 已经无感了，使劲用也只是几毛钱。今天问了挺多问题，处理了不少内容，也才￥0.7。",
            "让 AI 给我写了一个 README.md，写得还不错。",
            "网站的问题慢慢解决了，感觉现在没有什么新内容，反而有点空虚了。",
        ]
    },
    {
        date: "2026-07-10",
        paragraphs: [
            "考完试回家了。",
            "Trae 有一个弊端，就是时常要更新，不更新还用不了。",
            "运行网站时还出现了一个问题，就是一开始编辑日记保存之后是保留在编辑页面的，不过最好的是保存之后直接到日记页面，所以我之前改了；但现在发现如果直接转到日记页面，则网站自动弹出的是否允许关联本地文件的弹窗按不到就自动转到日记页面，所以我就把这个功能删掉了。",
            "考虑到日记大多是流水账，并不适合一些深刻想法的记录，我觉得还是需要另一个记录载体。于是我就增加一个随笔功能，可以记录一些平时的思考。",
            "发现处理双引号会出问题，\"试试日记有没有问题\"，这样应该是没问题的了。",
        ]
    },
    {
        date: "2026-07-11",
        paragraphs: [
            "感觉更新的内容可以不在日记里面记录，在更新日志里面记录就好了。",
        ]
    },
    {
        date: "2026-07-13",
        paragraphs: [
            "今天写随笔遇到一个问题，写到一半时如果要跳转其他网页，则原来写的内容会丢失，害我白白丢失了不少写作内容。而每次保存都要重新再进一次编辑页面，十分麻烦。我就设置了一个保存按钮，可以将当前已写的内容保存，且可以继续编辑，方便了不少。",
        ]
    }
];
