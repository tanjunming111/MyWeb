...
var defaultDiaryData = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            "不知道为什么，今天额度一下子就用完了，可能是字节想要赚钱，减少了每日提供的额度。后面在 Deepseek 上买了十块钱的 Tokens，用API密钥导入 Trae，就可以在 Trae 里用了。一开始用V4-Pro 问了一个问题，花了￥0.16，有点小贵。后来换成 V4-Flash（这个便宜一点，性价比高），重新开了对话（可以减少AI对上下文的思考），问了一个问题，只要￥0.02。以后还是用V4-Flash好。",
        ]
    }
];
